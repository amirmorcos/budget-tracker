This is the Budget Tracker Task, bootstrapped using [`@react-native-community/cli`](https://github.com/react-native-community/cli).
...
5. React Pie chart : for buget categories visual representation
