...
const NoTransactionsIcon = (props: SvgProps) => (
  <Svg width={312} height={312} fill="none" {...props}>
    <Mask
      id="a"
      width={312}
      height={312}
    ...
    <G mask="url(#a)">
      <Path
        fill="#E5E5EE"
        d="M58.691 79.943C78.718 63.537 136 54.479 162.136 52c-11.122 5.73-30.536 26.713-19.217 64.814-40.106 6.658-82.33 18.767-98.43 23.99-3.61-13.452-5.825-44.456 14.202-60.861Z"
      />
      <Path
        fill="url(#b)"
        fillOpacity={0.36}
      ...
      <Path
        fill="#7F3DFF"
        d="M270.664 102.291c-1.987 3.515-8.875 5.048-15.548 1.76-6.674-3.288-12.193-9.917-10.207-13.431 1.987-3.515 15.311-3.288 21.985 0 6.674 3.287 5.756 8.157 3.77 11.671Z"
      />
      <Path
        fill="url(#e)"
        fillOpacity={0.64}
...
export default NoTransactionsIcon;
